...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (@DiganosisConceptID)
...
select a.cohort_definition_id, a.subject_id, a.cohort_start_date, a.cohort_end_date, d.year_of_birth, d.gender_source_value, b.condition_concept_id, c.concept_name, b.condition_start_date, e.death_date, z.stagedet
...
left outer join @cdm_database_schema.cancer_tnm z on a.subject_id = z.person_id;
...
TRUNCATE TABLE @target_database_schema.@target_cohort_table;
